...
def main():
    ...
    task_dims_parser.add_argument("--page-size", type=int, default=2000, help="后端分页大小（默认 2000）")
    task_dims_parser.add_argument("--debug-api", action="store_true", help="显示接口请求次数和耗时")
    task_dims_parser.add_argument("--api-workers", type=int, default=8, help="分页接口并发数（默认 8）")
