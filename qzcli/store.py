...
class JobRecord:
    ...
    @classmethod
    def from_notebook_response(
        cls, data: Dict[str, Any], workspace_id: str = "", workspace_name: str = ""
    ) -> "JobRecord":
...
class JobStore:
        ...
        if self.store_file.exists():
            try:
                with open(self.store_file, "r", encoding="utf-8") as f:
                    ...
                    self._jobs = {
                        k: JobRecord.from_dict(v) for k, v in jobs_data.items()
                    }
    ...
    def update_from_api(
        self, job_id: str, api_data: Dict[str, Any]
    ) -> Optional[JobRecord]:
        """从 API 响应更新任务"""
        self._ensure_loaded()
